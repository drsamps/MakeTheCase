...
const getPersonaInstructions = (persona: CEOPersona, studentName: string, caseTitle: string): string => {
  const instructions: Record<CEOPersona, string> = {
...
**Your Persona:**
${getPersonaInstructions(persona, studentName, caseData.case_title)}
