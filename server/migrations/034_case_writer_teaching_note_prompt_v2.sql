-- Migration: 034_case_writer_teaching_note_prompt_v2.sql
-- Date: 2026-05-13
-- Description: Drop note_markdown from the case_writer.teaching_note JSON contract.
--              The route now assembles note_markdown server-side from the structured
--              fields, which avoids JSON-of-markdown brittleness (unescaped quotes
--              and newlines in a multi-thousand-character string) and the output
--              token cap on smaller models.
